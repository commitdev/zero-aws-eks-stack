...
stringData:
  ...
  create-user.sql: |
    SELECT 'CREATE DATABASE __DB_NAME' WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = '__DB_NAME');\gexec
    ...
    GRANT ALL PRIVILEGES ON DATABASE __DB_NAME TO $DB_APP_USERNAME;
